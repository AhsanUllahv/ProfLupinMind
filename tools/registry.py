TOOL_REGISTRY = {
    ...
    "nmap": {
        ...
        "example": "nmap -sV -sC -A -T4 <target>",
    },
    "nmap-root": {
    ...
    "rustscan": {
        ...
        "example": "rustscan -a <target> -- -sV -sC",
    },
    "netdiscover": {
    ...
    "ffuf": {
        ...
        "dangerous": False, "requires_root": False, "timeout": 300, "category": "web",
        "target_flag": "-u",
        "example": "ffuf -u http://<target>/FUZZ -w /usr/share/wordlists/dirb/common.txt",
    },
    "feroxbuster": {
        ...
        "dangerous": False, "requires_root": False, "timeout": 300, "category": "web",
        "target_flag": "-u",
        "example": "feroxbuster -u https://<target> -w /usr/share/wordlists/dirb/common.txt",
    },
    "dirsearch": {
        ...
        "dangerous": False, "requires_root": False, "timeout": 300, "category": "web",
        "target_flag": "-u",
        "example": "dirsearch -u http://<target>",
    },
    "dirb": {
    ...
    "wpscan": {
        ...
        "dangerous": False, "requires_root": False, "timeout": 300, "category": "web",
        "target_flag": "--url",
        "always_flags": "--no-update --request-timeout 15",
        "example": "wpscan --url https://<target> --enumerate vp,u --no-update --request-timeout 15",
    },
    "sqlmap": {
    ...
    "nuclei": {
        ...
        "dangerous": False, "requires_root": False, "timeout": 300, "category": "web",
        "target_flag": "-u",
        "example": "nuclei -u http://<target> -severity critical,high",
    },
    "dalfox": {
    ...
    "arjun": {
        ...
        "dangerous": False, "requires_root": False, "timeout": 120, "category": "web",
        "target_flag": "-u",
        "example": "arjun -u http://<target>/api/endpoint",
    },
    "wfuzz": {
        ...
        "dangerous": False, "requires_root": False, "timeout": 300, "category": "web",
        "example": "wfuzz -c -z file,/usr/share/wordlists/dirb/common.txt http://<target>/FUZZ",
    },
    "hakrawler": {
        ...
        "dangerous": False, "requires_root": False, "timeout": 120, "category": "web",
        "stdin_target": True,
        "example": "echo http://<target> | hakrawler",
    },
    "katana": {
    ...
    "httpx": {
        ...
        "dangerous": False, "requires_root": False, "timeout": 120, "category": "web",
        "example": "echo <domain> | httpx -sc -title -td",
    },
    "x8": {
        ...
        "dangerous": False, "requires_root": False, "timeout": 120, "category": "web",
        "target_flag": "-u",
        "example": "x8 -u 'http://<target>/' -w params.txt",
    },
    "autorecon": {
    ...
    "checkov": {
        ...
        "dangerous": False, "requires_root": False, "timeout": 120, "category": "cloud",
        "example": "checkov -d /path/to/terraform",
    },
    "terrascan": {
